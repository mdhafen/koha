          ...
          <span>
            ...
            <a>
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <xsl:attribute name="href">/cgi-bin/koha/catalogue/search.pl?idx=au&amp;q=<xsl:value-of select="marc:subfield[@code='a']"/><xsl:text> </xsl:text><xsl:value-of select="marc:subfield[@code='b']"/></xsl:attribute>
                </xsl:otherwise>
              </xsl:choose>
              <xsl:if test="marc:subfield[@code='a']">
                <xsl:value-of select="marc:subfield[@code='a']"/>
