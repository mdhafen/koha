...
my $query = "";
my @query_params;
my @columns = ( "issuedate", "i.renewals", "returndate", "date_due", "itemcallnumber", "barcode", "replacementprice", "itemnotes", "borrowernumber", "itemnumber" );
my $where = "";
