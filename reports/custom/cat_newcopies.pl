...
my @column_titles = ( "Title", "Call Number", "Barcode", "Added" );

my $query = "";
my @query_params;
my @columns = ( "CONCAT_WS(' ', biblio.title, biblio.subtitle ) AS title", "itemcallnumber", "barcode", "dateaccessioned", "biblionumber" );
my $where = "";
my $order = "title";
my $group = "";
