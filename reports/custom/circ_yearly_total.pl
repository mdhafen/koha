...
sub calculate {
    ...
    while ( my ( @values ) = $sth->fetchrow ) {
	    ...
	    for ( $values[0] ) {
            if    ( $_ gt '2026-05-26' ) { $year = '2026-2027' }
            elsif ( $_ gt '2025-05-22' ) { $year = '2025-2026' }
            elsif ( $_ gt '2024-05-23' ) { $year = '2024-2025' }
            elsif ( $_ gt '2023-05-25' ) { $year = '2023-2024' }
            elsif ( $_ gt '2022-05-26' ) { $year = '2022-2023' }
